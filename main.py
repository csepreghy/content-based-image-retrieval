...
igm = cv2.imread("object_categories/brain/image_0003.jpg",
                 cv2.IMREAD_GRAYSCALE)

sift = cv2.xfeatures2d.SIFT_create()
(keypoints, descriptors) = sift.detectAndCompute(igm, None)

igm = cv2.drawKeypoints(igm, keypoints, None)

cv2.imshow("Image", igm)
cv2.waitKey(0)
