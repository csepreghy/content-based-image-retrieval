...
df_10_categories = get_results_dataframe(all_categories, n_categories=10)
# df_5_categories = get_results_dataframe(all_categories, n_categories=5)

print(df_10_categories.head(30))
print(df_10_categories.tail())
...
with open("./pickles/dataframe_all_categories.pickle", "wb") as handle:
    pickle.dump(df_categories, handle, protocol=pickle.HIGHEST_PROTOCOL)
  
with open("./pickles/dataframe_10_categories.pickle", "wb") as handle:
    pickle.dump(df_10_categories, handle, protocol=pickle.HIGHEST_PROTOCOL)
